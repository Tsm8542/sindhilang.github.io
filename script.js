...
function s(){
    ...
    switch(a){
        case 'balbharti':
            ...
            break;
        case 'bidayatul_arabiya':
            m.innerHTML = create_option("std","Std ",8,8);
            break;
        case 'kumarbharti':
            m.innerHTML = create_option("std","Std ",9,10);
            break;
        case 'sindhubharti_arabic':
            m.innerHTML = create_option("std","Std ",9,10);
            break;
        case 'sindhubharti':
            m.innerHTML = create_option("std","Std ",6,8);
            break;
        case 'yuvakbharti':
...
function x(){
    ...
    if(document.querySelector("#genre").value=="bidayatul_arabiya"){
        switch(s){
            case 'std8':
    ...
    if(document.querySelector("#genre").value=="kumarbharti"){
        switch(s){
            case 'std9':
    ...
    if(document.querySelector("#genre").value=="sindhubharti_arabic"){
        switch(s){
            case 'std9':
    ...
    if(document.querySelector("#genre").value=="sindhubharti"){
        switch(s){
            case 'std6':
    ...
    if(document.querySelector("#genre").value=="yuvakbharti"){
        switch(s){
            case 'std11':
                t.innerHTML = create_pr(11,4);
                break;
            case 'std12':
                t.innerHTML = create_pr(12,4);
                break;
            default:
                t.innerHTML = create_pr(11,4);
                break;
...
function z(){
    ...
    if(genre=="balbharti")genre="Balbharti Sindhi";
    else if(genre=="bidayatul_arabiya")genre="Bidayatul-Arabiya (Sindhi)";
    else if(genre=="kumarbharti")genre="Kumarbharti Sindhi";
    else if(genre=="sindhubharti_arabic")genre="Sindhubharti Sindhi (Arabic)";
    else if(genre=="sindhubharti")genre="Sindhubharti Sindhi";
    else if(genre=="yuvakbharti")genre="Yuvakbharti Sindhi";
    let m="";
